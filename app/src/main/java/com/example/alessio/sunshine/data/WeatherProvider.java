package com.example.alessio.sunshine.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    public int update(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case WEATHER:
                updatedRows = db.update(WeatherContract.WeatherEntry.TABLE_NAME, contentValues, selection, selectionArgs);
                break;
            case LOCATION:
                updatedRows = db.update(WeatherContract.LocationEntry.TABLE_NAME, contentValues, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unkown uri: " + uri);
        }
